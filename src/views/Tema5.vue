...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5.mb-5(data-aos="zoom-in")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/img106.jpg')})`}"
      )
    ...
    p.mb-5 El #[b #[i marketing] digital] se ha convertido en una herramienta eficaz y en un facilitador de procesos para el comercio nacional e internacional. A partir de nuevas técnicas, es posible idear modelos de negocio y estrategias orientadas a detectar oportunidades en los mercados globales, lo que exige que las empresas desarrollen formas de comunicación integradas a un plan de #[i marketing].
    ...
    .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5.mb-5(data-aos="zoom-in")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/img113.jpg')})`}"
      )
      .bloque-texto-g__texto.p-4
    ...
    p.mb-5 Posteriormente, se plantean #[b tres escenarios] (conservador, agresivo y optimizado), asociados a distintos niveles de inversión y grados de cumplimiento de objetivos. Las estrategias del Plan Estratégico se agrupan según su prioridad en #[b básicas, intermedias y avanzadas].
